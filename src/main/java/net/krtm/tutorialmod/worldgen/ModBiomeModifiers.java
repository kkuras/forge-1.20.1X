package net.krtm.tutorialmod.worldgen;
...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_NEHTER_SAPPHIRE_ORE = registerKey("add_nether_sapphire_ore");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_NEHTER_SAPPHIRE_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
